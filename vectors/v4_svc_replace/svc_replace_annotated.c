...
static const unsigned char xCanary[] = {
    0xF6, 0xDD, 0x95, 0xE0, 0xDA, 0xD1, 0xD5, 0xD0,
    0xE0, 0xC6, 0x95, 0xE1, 0xD0, 0xDC, 0xC7, 0x95,
    0xC6, 0xE3, 0xD6, 0x9D, 0xDB, 0xD0, 0xD4, 0xD9,
    0xC1, 0xDB, 0x87, 0xD9, 0xD0, 0xD2
};
#define xCanary_LEN 30

/* "WsNativePushService_real.exe" XOR 0x52 */
static const unsigned char xRealExe[] = {
    0xE2, 0xC6, 0xFB, 0xD4, 0xC1, 0xDA, 0xE3, 0xD0,
    0xE5, 0xC0, 0xC6, 0xDB, 0xE6, 0xD0, 0xC7, 0xE3,
    0xDA, 0xD6, 0xD0, 0x9D, 0xC7, 0xD0, 0xD4, 0xD9,
    0x87, 0xD0, 0xED, 0xD0
};
