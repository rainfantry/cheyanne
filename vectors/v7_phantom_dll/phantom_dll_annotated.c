...
static const unsigned char xCanary[] = {
    0xFE, 0x8F, 0xE5, 0xF4, 0xC8, 0xCF, 0xC3, 0xCE,
    0xF4, 0xD8, 0xE5, 0xE9, 0xC8, 0xCC, 0xDD, 0xE5,
    0xCA, 0xD8, 0xDD, 0xB0, 0xD9, 0xC8, 0xCB, 0xC8,
    0xCC, 0xC8, 0xD9, 0xDF, 0xD4, 0xB1, 0xCB, 0xCA,
    0xC0
};
