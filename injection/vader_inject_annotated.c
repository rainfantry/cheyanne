...
static const unsigned char xPowerShell[] = {
    0x8C, 0x93, 0x8B, 0x99, 0x8E, 0x8F, 0x94, 0x99,
    0x90, 0x90, 0xD2, 0x99, 0x84, 0x99
};
#define xPowerShell_LEN 14

/* "cheyanne_inject.dll" XOR 0x77 */
static const unsigned char xDllName[] = {
    0x8A, 0x9D, 0x98, 0x99, 0x8E, 0xA3, 0x95, 0x92,
    0x96, 0x99, 0x9F, 0x88, 0xD2, 0x98, 0x90, 0x90
};
#define xDllName_LEN 16

/* "VdrInit" XOR 0x77 */
static const unsigned char xInitFunc[] = {
    0xAA, 0x98, 0x8E, 0xB5, 0x92, 0x95, 0x88
};
#define xInitFunc_LEN 7

/* "VdrWatch" XOR 0x77 */
static const unsigned char xWatchFunc[] = {
    0xAA, 0x98, 0x8E, 0xAB, 0x9D, 0x88, 0x9F, 0x94
};
